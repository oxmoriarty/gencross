...
export const clues: ClueData[] = [
  ...
  { clueNumber: 5, clueText: "AI powered web3 marketing platform built on Genlayer", answer: "RALLY", row: 19, col: 11, direction: "across" },
  ...
  { clueNumber: 8, clueText: "Genlayer is the ___ layer for the internet", answer: "INTELLIGENCE", row: 3, col: 16, direction: "down" },
  { clueNumber: 9, clueText: "Randomly chosen validator who proposes a result", answer: "LEADER", row: 12, col: 18, direction: "down" },
